...
export default function NewGalleryPhotoPage() {
  ...
  useEffect(() => {
    // Fetch events, projects, and team members for reference selection
    fetchReferences();
  }, []);
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Add New Photo</h1>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          {previewUrl ? (
            ...
            <div className="aspect-square bg-gray-100 rounded-lg flex items-center justify-center">
              <p className="text-gray-400">Enter a valid Google Drive URL to see preview</p>
            </div>
          )}
        </div>
      </div>
